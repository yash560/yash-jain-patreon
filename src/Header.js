...
function Header() {
  return (
    <div>
      <div class="Patreonheader">
        <div class="PatreonheaderLeft">
          <div class="PatreonheaderLogo">
            <img
          ...
          {/* <div class="PatreonheaderLeftComponent productComponent">
          ...
          {/* <div class="PatreonheaderLeftComponent creatorComponent">
          ...
          <div class="PatreonheaderLeftComponent">Home</div>
          {/* <div class="PatreonheaderLeftComponent resourcesComponent">
          ...
          <div class="PatreonheaderLeftComponent">Community</div>
        </div>
        <div class="PatreonheaderRight">
          {/* <input
            class="PatreonheaderSearchbar"
            type="text"
            name="search"
            placeholder="Find a Creator "
          /> */}
          <div class="PatreonheaderRightComponent">Log In</div>
          <div class="createAccountButton">Join us</div>
        </div>
      </div>{" "}
      <div class="PatreonheaderSm">
        <input
          class="PatreonheaderSearchbarSM"
          type="text"
          name="search"
          placeholder="Find a Creator "
        />
